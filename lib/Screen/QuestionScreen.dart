...
import 'package:ielts_essay/Screen/AnswerScreen.dart';
...
class QuestionScreen extends StatefulWidget{
  QuestionScreen({Key key, this.data, this.questionModel, this.position, this.essayType}) : super(key: key);
...
class _QuestionScreen extends State<QuestionScreen> with AutoCancelStreamMixin{
  ...
  Iterable<StreamSubscription> get registerSubscriptions sync* {
    yield registerReceiver(['actionChange']).listen((intent) {
          // print(" dbHelper  isFavourite"+intent.extras['question'].isFavourite??'0');
          // print(" dbHelper  isSaved"+intent.extras['question'].isSaved??'0');
          setState(() {
            widget.questionModel.isFavourite = intent.extras['question'].isFavourite??'0';
            widget.questionModel.isSaved = intent.extras['question'].isSaved??'0';
          });
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text('Question',softWrap: true,style: TextStyle(fontSize: 40,color: Colors.white,fontWeight: FontWeight.w600,fontFamily: 'Poppins'),),
                ...
                child:ListView(
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child:InkWell(
                                ...
                                onTap: (){
                                  Share.share('Question: \n'+widget.questionModel.question+'\n\n\nEssay Type: \n'+widget.essayType.toString(), subject: 'IELTS Essay');
                                },
                              ),
                    ...
                    ListView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount: answerList.length>5?5:answerList.length,
                            ...
                            child: InkWell(
                              child: Container(
                                  ...
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: [
                                      Text('Answer '+(index+1).toString(),style: TextStyle(fontSize: 17,color: Colors.black,fontWeight: FontWeight.w500,fontFamily: 'Poppins'),),
                                      Expanded(
                                        child: Align(
                              ...
                              onTap: (){
                                ...
                                Navigator.push(
                                    ...
                                    PageTransition(
                                        ...
                                        child: AnswerScreen(data: widget.data, questionModel: widget.questionModel,answerModel: answerList[index], position: widget.position,essayType:widget.essayType.toString())));
