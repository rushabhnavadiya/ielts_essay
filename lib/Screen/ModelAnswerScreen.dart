...
class ModelAnswerScreen extends StatefulWidget{
  ModelAnswerScreen({Key key,this.questionModel, this.answerModel, this.position, this.ansPos, this.essayType}) : super(key: key);
  ...
  _ModelAnswerScreen createState() =>_ModelAnswerScreen();
}

class _ModelAnswerScreen extends State<ModelAnswerScreen>{
            ...
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text('Model Answer',softWrap: true,style: TextStyle(fontSize: 40,color: Colors.white,fontWeight: FontWeight.w600,fontFamily: 'Poppins'),),
              ...
              Expanded(
                child:ListView(
                  ...
                  // child: Container(
                  //   height: MediaQuery.of(context).size.height - cH(35),
